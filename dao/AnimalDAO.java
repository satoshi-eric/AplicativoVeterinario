...
public class AnimalDAO extends GenericDAO {
    ...
    public Animal create(
        ...
        try {
            ...
            stmt = GenericDAO.getConnection().prepareStatement(
                    "INSERT INTO animal (nome, ano_nasc, sexo, id_especie, id_cliente) VALUES (?,?,?,?,?)");
    ...
    public List retrieveByIdSimilarName(int id, String nome) {
    ...
    public void update(Animal animal) {
        try {
            PreparedStatement stmt;
            stmt = GenericDAO.getConnection().prepareStatement(
                    "UPDATE animal SET  nome=?, ano_nasc=?, sexo=?, id_especie=?, id_cliente=? WHERE id=?");
    ...
    public void delete(Animal animal) {
        PreparedStatement stmt;
        try {
            stmt = GenericDAO.getConnection().prepareStatement("DELETE FROM animal WHERE id = ?");
