...
// CRUD
    public Exame create(String descricao, int idConsulta) {
        try {
            ...
            stmt = GenericDAO.getConnection().prepareStatement("INSERT INTO exame (descricao, id_consulta) VALUES (?,?)");
    ...
    public void update(Exame exame) {
        try {
            PreparedStatement stmt;
            stmt = GenericDAO.getConnection().prepareStatement("UPDATE exame SET descricao=?, idConsulta=? WHERE id=?");
    ...
    public void delete(Exame exame) {
        PreparedStatement stmt;
        try {
            stmt = GenericDAO.getConnection().prepareStatement("DELETE FROM exame WHERE id = ?");
