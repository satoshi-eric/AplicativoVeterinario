...
public class EspecieDAO extends GenericDAO {
    ...
    public Especie create(String nome) {
        try {
            ...
            stmt = GenericDAO.getConnection().prepareStatement("INSERT INTO especie (nome) VALUES (?)");
    ...
    public Especie retrieveByNome(String nome) {
    ...
    public void update(Especie especie) {
        try {
            PreparedStatement stmt;
            stmt = GenericDAO.getConnection().prepareStatement("UPDATE especie SET nome=? WHERE id=?");
    ...
    public void delete(Especie especie) {
        PreparedStatement stmt;
        try {
            stmt = GenericDAO.getConnection().prepareStatement("DELETE FROM especie WHERE id = ?");
