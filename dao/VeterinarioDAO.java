...
public class VeterinarioDAO extends GenericDAO {
    ...
    public Veterinario create(
        ...
        try {
            ...
            stmt = GenericDAO.getConnection().prepareStatement("INSERT INTO veterinario (nome, email, telefone) VALUES (?,?,?)");
    ...
    public List retrieveLast(){
        return this.retrieve("SELECT * FROM veterinario WHERE id = " + lastId("veterinerio","id"));
    }
    ...
    public List retrieveByNome(String nome) {
        return this.retrieve("SELECT * FROM veterinario WHERE nome = " + nome);
    }

    public List retrieveByIdEmail(String email) {
        return this.retrieve("SELECT * FROM veterinario WHERE email = " + email);
    }

    public List retrieveByTerminado(String telefone) {
        return this.retrieve("SELECT * FROM veterinario WHERE telefone = " + telefone);
    }
    ...
    public void update(Veterinario veterinario) {
        try {
            PreparedStatement stmt;
            stmt = GenericDAO.getConnection().prepareStatement("UPDATE veterinario SET nome=?, email=?, telefone=? WHERE id=?");
    ...
    public void delete(Veterinario veterinario) {
        PreparedStatement stmt;
        try {
            stmt = GenericDAO.getConnection().prepareStatement("DELETE FROM veterinario WHERE id = ?");
